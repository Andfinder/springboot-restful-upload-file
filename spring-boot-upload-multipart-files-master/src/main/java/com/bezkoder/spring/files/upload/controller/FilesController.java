...
import com.bezkoder.spring.files.upload.model.UploadFileModel;
...
public class FilesController {
  ...
  @PostMapping("/many")
  public ResponseEntity<ResponseMessage> uploadFileMany(@ModelAttribute UploadFileModel model){
	  System.out.println("上传多个多个文件");
	  ...
	  return ResponseEntity.status(HttpStatus.OK).body(new ResponseMessage("上传多个文件"));
  }
